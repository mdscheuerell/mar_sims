...
pdf("plots/Figure_2_individual.pdf")
...
g1 = ggplot(post_summary[post_summary$iter<95,],
  ...
  scale_x_continuous(breaks=c(1,2,3,4),
                     labels=c("1"=expression(atop(paste(sigma[obs],"= 0.2"), paste(sigma[pro],"= 0.2"))),
                              "2"=expression(atop(paste(sigma[obs],"= 0.2"), paste(sigma[pro],"= 0.4"))),
                              "3"=expression(atop(paste(sigma[obs],"= 0.4"), paste(sigma[pro],"= 0.2"))),
                              "4"=expression(atop(paste(sigma[obs],"= 0.4"), paste(sigma[pro],"= 0.4"))))) +
  #scale_x_discrete(labels = c("1" = expression(atop(paste(sigma[obs],"= 0.2"), paste(sigma[pro],"= 0.2"))),
  #"2" = expression(atop(paste(sigma[obs],"= 0.2"), paste(sigma[pro],"= 0.4"))),
  #"3" = expression(atop(paste(sigma[obs],"= 0.4"), paste(sigma[pro],"= 0.2"))),
  #"4"   = expression(atop(paste(sigma[obs],"= 0.4"),paste(sigma[pro],"= 0.4"))))) +
